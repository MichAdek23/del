        ...
        <Card style={styles.settingCard}>
          <View style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <View>
                <Text style={styles.settingText}>Delivery Notifications</Text>
                <Text style={styles.settingSubtext}>Get updates on your deliveries</Text>
              </View>
            </View>
            <Switch
              value={notifications.delivery}
              onValueChange={(val) =>
                setNotifications({ ...notifications, delivery: val })
              }
              trackColor={{ false: '#ddd', true: colors.primary + '40' }}
              thumbColor={notifications.delivery ? colors.primary : '#fff'}
            />
          </View>
          <View style={styles.divider} />
          <View style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <View>
                ...
                <Text style={styles.settingSubtext}>Receive offers and updates</Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingLeft}>
              ...
              <View>
                ...
                <Text style={styles.settingSubtext}>Easy on the eyes</Text>
              </View>
            </View>
            <Switch
              value={darkMode}
